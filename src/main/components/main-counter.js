...
import '../../modules/counter/components/counter-element';

// These are the shared styles needed by this element.
import { SharedStyles } from '../../shared/styles/shared-styles';

class MainViewCounter extends connect(store)(PageViewElement) {
  ...
  render() {
    return html`
      ...
      <section>
        <p>
          <counter-element value="${this._value}" clicks="${this._clicks}" @counter-incremented="${this._counterIncremented}"
...
window.customElements.define('main-counter', MainViewCounter);
